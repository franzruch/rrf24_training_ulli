...
%%% iebaltab hh_size n_child_5 n_elder read sick female_head livestock_now area_acre_w drought_flood crop_damage, grpvar(treatment) rowvarlabels format(%12.3f) savecsv("C:/Temp/Github/rrf24_training_ulli/Stata/Outputs/balance") savetex("C:/Temp/Github/rrf24_training_ulli/Stata/Outputs/balance") nonote addnote(" Significance: ***=.01, **=.05, *=.1") replace
